                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">ID Compensación</th>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Hora Inicial / Final</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($solicitudes as $solicitud)
                            ...
                            @endphp
                            <tr class="hover:bg-gray-50 @if(!$esValida && $solicitud->id_estado == $this->estadoSolicitadaId) bg-red-50 @endif">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if($solicitud->id_estado == $this->estadoSolicitadaId)
                                    <input type="checkbox"
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <div class="text-sm text-gray-500">
                                        ...
                                        {{ optional($solicitud->persona)->apellido }}
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    {{ optional($solicitud->hrs_inicial)->format('H:i') ?? '-' }} / {{ optional($solicitud->hrs_final)->format('H:i') ?? '-' }}
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    @elseif($solicitud->id_estado == $this->estadoAprobadaId)
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                            ✅ Aprobada
                                        </span>
                                    @elseif($solicitud->id_estado == $this->estadoRechazadaId)
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    @if(!$esValida && $solicitud->id_estado == $this->estadoSolicitadaId)

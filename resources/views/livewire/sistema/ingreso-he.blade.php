        ...
        <div class="relative w-full max-w-md p-4">
            <div class="relative bg-white rounded-lg shadow border border-gray-200">
                ...
                <div class="flex items-center justify-between p-4 border-b rounded-t">
                    ...
                    <button wire:click="$set('modalEstadosVisible', false)" type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center">
                ...
                <!-- Modal body -->
                <div class="p-4">
                    <!-- Aquí el bloque copiado -->
                    <ul class="flex flex-col mb-4 lg:mb-6">
                        <!-- ...los <li> copiados... -->
                    </ul>
                    <!-- Aquí sigue el listado de estados -->
                    <ul>
                        @forelse($estadosSolicitud as $estado)
                            <li class="mb-2">
                                <span class="font-semibold">#{{ $estado['id'] }}</span>
                                <span class="font-semibold ml-2">{{ $estado['gls_estado'] }}</span>
                                <span class="text-xs text-gray-500 ml-2">({{ $estado['created_at'] }})</span>
                            </li>
                        @empty
                ...
                <div class="flex justify-end p-4 border-t">
                    <button wire:click="$set('modalEstadosVisible', false)" type="button" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition">
                        Cerrar
                    </button>
                </div>
            </div>

        ...
        <div class="relative bg-white rounded-lg shadow border border-gray-200">
            ...
            @forelse($estadosSolicitud as $estado)
                ...
                <li class="mb-10 ms-6">
                    ...
                    <h3 class="mb-1 text-lg font-semibold text-gray-900 dark:text-white">Estado: {{ $gls }}</h3>
                    <div class="text-sm text-gray-700 dark:text-gray-300">Descripción: {{ $descripcion }}</div>

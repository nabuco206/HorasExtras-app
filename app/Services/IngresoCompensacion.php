...
class IngresoCompensacion extends Component
{
    ...
    // Inyectar el servicio de bolsón
    protected $bolsonService;

    public function __construct($id = null)
    {
        parent::__construct($id);
        $this->bolsonService = app(BolsonService::class);
    }
    ...
    public function save()
    {
        ...
        // Descontar minutos del bolsón real
        ...
        // Guardar la solicitud de compensación solo si el descuento fue exitoso
